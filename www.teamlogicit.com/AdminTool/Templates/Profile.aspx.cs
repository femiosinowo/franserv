...
public partial class AdminTool_Templates_Profile : System.Web.UI.Page
{
            ...
            try
            {
               ...
               string profileImgPath = "";
                if (imageUpload.HasFiles)
                {
                    ...
                    {
                        lblError.Text = @"Selected Image dimensions are smaller than supported dimensions of 291 * 291. Please select new image.";
                        lblError.Visible = true;
                        return;
                    }
            ...
            try
            {
               ...
               string profileImgPath = "";
                if (imageUpload.HasFiles)
                {
                    ...
                    if (isImageDimensionsValid == false && imgPath == "")
                    {
                        lblError.Text = "Selected Image dimensions are smaller than supported demensions of 291 * 291. Please select new image.";
                        lblError.Visible = true;
                        return;
                    }                        
                ...
                {
                    isActive = 1;
                    CommunityUserHelper.UnLockUserAccount(txtUsername.Text);
                }
                else
                {
                    isActive = 0;
                    CommunityUserHelper.LockUserAccount(txtUsername.Text);
                }
    ...
    private string GetCmsImagePath(out bool imageStatus)
    {
        ...
        if (resultData != null && resultData.Id > 0)
        {
            ...
            if (calculatedWidth < 290 || calculatedHeight < 290)
            {
