...
public partial class AdminTool_Templates_AllCenterConsultationRequests : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            var subscribtionId = row.Cells[9].Text;
            ...
            if (subscribtionId != string.Empty)
            {
                ...
                if (sId > 0)
                {
                    AdminToolManager.DeleteConsultationRequest(sId);
                    this.BindGrid();
                }
            }
        }
    ...
    {
        List<ConsultationRequest> CentersConsultationRequests = null;
        ...
        {           
            ...
            if (centerData != null && !string.IsNullOrEmpty(centerData.FransId))
            {
                ...
                CentersConsultationRequests = AdminToolManager.GetAllCenterConsultationRequest(centerId);
                dt = ToDataTable<ConsultationRequest>(CentersConsultationRequests);
            }

            GridView1.DataSource = CentersConsultationRequests;
            GridView1.DataBind();
        }
    }    
