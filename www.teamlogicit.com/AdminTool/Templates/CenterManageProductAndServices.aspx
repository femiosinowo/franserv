    ...
    <asp:Panel ID="pnlProductsServices" CssClass="pnlProductsServices" runat="server">
        ...
        <div align="left">
            ...
            <ol>
                ...
                <li>Click on 'Save' button to save the selected Main Category & Sub-Category selection.</li>
                <li>Repeat above steps to select all the Main & sub-Categories of Products & Services.</li>
