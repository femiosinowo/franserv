<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTool/MasterPages/admin.master" AutoEventWireup="true" CodeFile="CenterManageITServices.aspx.cs" Inherits="AdminTool_Templates_CenterManagePromos" %>
...
<div id="drag">
        <asp:Panel ID="pnlPromotions" runat="server">
            <p class="note">Drag & drop the Banners content from left column to right column.</p>           
            <div class="dragSection">
                ...
                <table>
                    ...
                    <tr>
                        <th colspan="1" class="mark" title="Message line">Available Manage IT</th>
                        <th colspan="1" class="mark" title="Message line">Selected Manage IT</th>
            ...
            <div id="bannersUpdateMsg" class="successMessage" runat="server" visible="false">
                Manage IT data saved Successfully!!!
            </div>
        </asp:Panel>
        <asp:Panel ID="pnlNoBannersResults" runat="server" Visible="false">
            <p>No Manage IT content are available for the Center.</p>
        </asp:Panel>
    </div>
</asp:Content>
