<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTool/MasterPages/admin.master" AutoEventWireup="true" CodeFile="AddTestimonial.aspx.cs" Inherits="AdminTool_Templates_AddTestimonial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainCPH" runat="Server">
    ...
    <asp:Panel ID="pnlManageTestimonial" runat="server" DefaultButton="btnAddTestimonial">       
        ...
        The recommended character length, for testimonials that you choose to display through out your site on pages like Managed Services, Consulting & Projects, etc, is 520 characters. </p>
        <br />
            ...
            <tbody>
                <tr>
                    <td class="CS_Form_Required_Baseline"><span class="CS_Form_Required_Baseline">
                            <strong> <label for="txtTitle">Title:</label></strong></span></td>
                    <td>
                        <asp:TextBox ID="txtTitle" runat="server" PlaceHolder="Title" size="30" MaxLength="520" TabIndex="1"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ValidationGroup="AddTestimonial" ControlToValidate="txtTitle" ForeColor="Red">*</asp:RequiredFieldValidator> 
                    </td>
                </tr>
                <tr>
                    <td class="CS_Form_Required_Baseline"><span class="CS_Form_Required_Baseline">
                    ...
                    <td>
                        <asp:TextBox ID="txtFirstName" runat="server" placeHolder="First Name" size="30" MaxLength="520" TabIndex="2"></asp:TextBox>                   
                    </td>
                </tr>
                <tr>
                    <td class="CS_Form_Required_Baseline"><span class="CS_Form_Required_Baseline">
                    ...
                    <td>
                        <asp:TextBox ID="txtLastName" runat="server" placeHolder="Last Name" size="30" MaxLength="520" TabIndex="3"></asp:TextBox>        
                    </td>
                </tr>
                <tr>
                    <td class="CS_Form_Required_Baseline"><span class="CS_Form_Required_Baseline">
                    ...
                    <td>
                        <asp:TextBox ID="txtCompany" runat="server" placeHolder="Company" size="30" MaxLength="520" TabIndex="4"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtPhone" runat="server" placeHolder="Phone Number" size="30" MaxLength="520" TabIndex="5"></asp:TextBox>
                    </td>
                </tr> 
                                <tr>
                    <td class="CS_Form_Required_Baseline"><span class="CS_Form_Required_Baseline">
                    ...
                    <td>
                        <asp:TextBox ID="txtEmail" runat="server" placeHolder="Email Address" size="30" MaxLength="520" TabIndex="6"></asp:TextBox>
                    </td>
                </tr> 
                <tr>
                    <td class="CS_Form_Required_Baseline"><span class="CS_Form_Required_Baseline">
                ...
                <tr>
                    <td class="CS_Form_Required_Baseline"><span class="CS_Form_Required_Baseline">
                        <label for="chkAboutUs">About Us Section:</label></span></td>
                    <td>
                        <asp:CheckBox ID="chkAboutUs" runat="server" />
                    </td>
                </tr> 
                <tr>
                    <td class="CS_Form_Required_Baseline"><span class="CS_Form_Required_Baseline">
                        <label for="txtCompany">Manage IT Services Section:</label></span></td>
                    <td>
                        <asp:CheckBox ID="chkManageITServices" runat="server" />
                    </td>
                </tr> 
                <tr>
                    <td class="CS_Form_Required_Baseline"><span class="CS_Form_Required_Baseline">
                        <label for="txtCompany">Consulting & Projects Section:</label></span></td>
                    <td>
                        <asp:CheckBox ID="chkConsultingProjects" runat="server" />
                    </td>
                </tr>              
                <tr>
                    <td class="CS_Form_Required_Baseline"><span class="CS_Form_Required_Baseline">
