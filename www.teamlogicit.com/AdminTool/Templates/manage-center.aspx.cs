                    ...
                    if (allCenters != null && allCenters.Any())
                    {
                        ...
                        if (centerData != null && !string.IsNullOrEmpty(centerData.FransId))
                        {
                            ...
                            bool status = AdminToolManager.UpdateCenter(centerId, txtName.Text, address1, txtAddress2.Text, city, stateCode,
                                  ...
                                  txtContactLastName.Text, centerData.CmsCommunityGroupId, isCenterDeleted, txtWhitePaperDownloadEmail.Text, txtJobApplicationEmail.Text, txtSubscriptionEmail.Text, txtClientLoginURL.Text, txtRequestConsultation.Text, consultationid);
                            if (status)
                            {
                                centerInfoUpdateMsg.Visible = true;
                                FransDataManager.GetAllCenterData(true);
                            }
                            else
                            {
                                lblError.Visible = true;
    ...
    protected void btnThirdParty_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            if (centerId != "")
            {
                ...
                socialMediaData.ITInflectionsUrl = txtMarketingTangoUrl.Text;
    ...
    private void FillCenterData(string centerId)
    {
        ...
        if (centerDataList != null && centerDataList.Any())
        {
            ...
            if (centerData != null)
            {
                ...
                txtRequestConsultation.Text = centerData.RequestConsultationEmail;
    ...
    {        
        ...
        if (thirdPartyData != null)
        {
            ...
            if (socialMediaData != null)
            {
                ...
                txtMarketingTangoUrl.Text = socialMediaData.ITInflectionsUrl;
            }
        }
    }
