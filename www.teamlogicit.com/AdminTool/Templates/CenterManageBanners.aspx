...
<asp:Content ID="Content2" ContentPlaceHolderID="mainCPH" runat="Server">
    ...
    <div id="drag">
        <asp:Panel ID="pnlPromotions" runat="server">
            <p class="note">Drag & drop the Banners content from left column to right column. <br /> Six banners must be selected and no more than six can be active at any time.</p>
            <div class="dragSection">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <th colspan="1" class="mark" title="Message line">Selected Banners</th>
