...
<asp:Content ID="Content2" ContentPlaceHolderID="mainCPH" runat="Server">
    ...
    <div>
        ...
        <a href="/AdminTool/Templates/Center.aspx?type=add">Add Business</a>
        <br />
        <br />
        ...
        <asp:GridView ID="GridView1" CssClass="centerData" HeaderStyle-BackColor="#6A6A6A" HeaderStyle-ForeColor="#FE9901" AllowSorting="true" OnSorting="GridView1_Sorting"
            ...
            <Columns>                
                ...
                <asp:BoundField DataField="FranservId" SortExpression="FranservId" HeaderText="Franserv Id" HeaderStyle-Width="100px" />
                ...
                <asp:BoundField DataField="FransId" SortExpression="FransId" ItemStyle-CssClass="hidden" HeaderText="" HeaderStyle-Width="150px" />
            </Columns>
            <EmptyDataTemplate>
