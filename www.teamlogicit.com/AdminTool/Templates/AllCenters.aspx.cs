...
public partial class AdminTool_Templates_AllCenters : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            var centerId = row.Cells[11].Text;
    ...
    private void BindGrid()
    {
        ...
        if (ViewState["CurrentAlphabet"] != null)
        {
            ...
            if (selectedAlphabet != "ALL")
            {
                ...
                var sortedList = filteredList.OrderBy(x => x.CenterName).Reverse().ToList();
                dt = ToDataTable<FransData>(sortedList);
            ...
            {
                var sortedList = centerData.OrderBy(x => x.CenterName).Reverse().ToList();
                dt = ToDataTable<FransData>(sortedList);
                DataView sortedView = new DataView(dt);
