<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTool/MasterPages/admin.master" AutoEventWireup="true" CodeFile="CenterManageProjectExperts.aspx.cs" Inherits="AdminTool_Templates_CenterManagePromos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainCPH" runat="Server">
    ...
    <h3>Manage Consulting & Projects</h3>
    <br />       
    
<div id="drag">
        <asp:Panel ID="pnlPromotions" runat="server">
            <p class="note">Drag & drop the Consulting & Projects content from left column to right column.</p>           
            <div class="dragSection">
                ...
                <table>
                    ...
                    <tr>
                        <th colspan="1" class="mark" title="Message line">Available Consulting & Projects</th>
                        <th colspan="1" class="mark" title="Message line">Selected Consulting & Projects</th>
            ...
            <br />
            <asp:Button ID="btnBanners" CssClass="btnBanners" runat="server" Text="Continue" OnClick="btnBanners_Click" />
            ...
            <div id="bannersUpdateMsg" class="successMessage" runat="server" visible="false">
                Consulting & Projects data saved Successfully!!!
            </div>
        </asp:Panel>
        <asp:Panel ID="pnlNoBannersResults" runat="server" Visible="false">
            <p>No Consulting & Projects content are available for the Center.</p>
        </asp:Panel>
    </div>
</asp:Content>
