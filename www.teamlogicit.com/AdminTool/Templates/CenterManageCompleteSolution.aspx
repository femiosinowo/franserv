<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTool/MasterPages/admin.master" AutoEventWireup="true" CodeFile="CenterManageCompleteSolution.aspx.cs" Inherits="AdminTool_Templates_CenterManagePromos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainCPH" runat="Server">
    ...
    <h3>Manage All IT Solutions</h3>
    <br />       
    
<div id="drag">
        <asp:Panel ID="pnlPromotions" runat="server">
            <p class="note">Drag & drop IT Solutions content from left column to right column.</p>           
            <div class="dragSection">
                ...
                <table>
                    ...
                    <tr>
                        <th colspan="1" class="mark" title="Message line">Available IT Solutions</th>
                        <th colspan="1" class="mark" title="Message line">Selected IT Solutions</th>
            ...
            <div id="bannersUpdateMsg" class="successMessage" runat="server" visible="false">
                Manage All IT Solutions data saved Successfully!!!
            </div>
        </asp:Panel>
        <asp:Panel ID="pnlNoBannersResults" runat="server" Visible="false">
            <p>No Manage All IT Solutions content are available for the Center.</p>
        </asp:Panel>
    </div>
</asp:Content>
