    ...
    <div id="CS_Element_adminleftnavmenu" title="" class="CS_Element_Schedule">
        ...
        <div class="cs_control CS_Element_LinkBar" id="cs_control_1937">
            <ul id="centerManageLinks" runat="server" visible="false">
                ...
                <li id="centerInfo" runat="server" visible="false"><a href="/admintool/templates/manage-center.aspx" class="aNav">Business Information</a> </li>
                 <li id="banners" runat="server"><a href="/admintool/templates/CenterManageBanners.aspx" class="aNav">Manage Banners</a> </li>
                <li id="whyWeAreDiff" runat="server" visible="false"><a href="/admintool/templates/Why_we_are_diff.aspx" class="aNav">Manage Our Story</a> </li>
            <!--<li id="managePSlist" runat="server"><a href="/admintool/templates/CenterManageProductAndServices.aspx" class="aNav">Manage Products And Services</a> </li>
                ...
                <li id="allProfiles" runat="server" visible="false"><a href="/admintool/templates/AllCenterProfiles.aspx" class="aNav">Manage All Profiles</a> </li>
                <li id="myTeam" runat="server" visible="false"><a href="/admintool/templates/Center-My-Team.aspx" class="aNav">My Team</a> </li>
            <!-- <li><a href="/admintool/templates/CenterManageITServices.aspx" class="aNav">Manage IT Services</a></li>-->
                <li><a href="/admintool/templates/CenterManageCompleteSolution.aspx" class="aNav">Manage All IT Solutions</a></li>
                <li><a href="/admintool/templates/CenterManageOurSolution.aspx" class="aNav">Manage Featured Solutions</a></li>
                <li><a href="/admintool/templates/CenterManageProjectExperts.aspx" class="aNav">Manage Consulting & Projects</a></li>
            <!--<li><a href="/admintool/templates/Center-Manage-Shop.aspx" class="aNav">Manage Shop Content</a> </li>
                ...
                <li><a href="/admintool/templates/AllCenterConsultationRequests.aspx" class="aNav">Manage All Consultation Requests</a> </li>
