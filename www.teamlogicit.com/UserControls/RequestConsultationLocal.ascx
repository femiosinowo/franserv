<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RequestConsultationLocal.ascx.cs"
    ...
    <div class="grid_24">
        <div id="requestconsultation_form">
            <div class="requestconsultation_header clearfix">
                ...
                <div class="grid_1 close_requestconsultation"><a id="close_x" class="close" href="#">X</a></div>
            </div>
