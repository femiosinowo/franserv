                        ...
                        <div class="sf_col clearfix">
                            <div class="prefix_1 grid_22 suffix_1">
                                ...
                                <div class="form" id="choose_center_register">
                                    ...
                                    <span class="required">*</span>
                                     <asp:TextBox ID="txtRegisterChooseLocation" CssClass="txtRegisterChooseLocation" runat="server" style=" display:none;"></asp:TextBox>
                                     <asp:RequiredFieldValidator ID="rfv2" runat="server" ControlToValidate="txtRegisterChooseLocation" CssClass="required"
                                            ValidationGroup="NationalRegister" ForeColor="Red" >*</asp:RequiredFieldValidator>
                                    <div class="clear"></div>
