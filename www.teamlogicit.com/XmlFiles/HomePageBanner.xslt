      ...
      <div class="main_rotator">
        ...
        <div id="top_slider">
          <div class="flexslider">
            <ul class="slides">
              <li id="slide_1">
                <div style="width: 1899px; height:500px; float: left; display: block;  background-image: url('/images/home_slider_bg.jpg')" class="slider-background-image">
                  <xsl:if test="backgroundImage/img != ''">
                    <xsl:attribute name="style">
                      width: 1899px; float: left; display: block;  background-image: url('<xsl:value-of select="backgroundImage/img/@src"></xsl:value-of>')
                    </xsl:attribute>
                  </xsl:if>
