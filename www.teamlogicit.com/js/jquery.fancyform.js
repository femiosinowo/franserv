        ...
        transformSelect: function (opts) {
			...
			method = {
			    init: function () {
			        ...
			        if (_touch) {
			            $("#ct100_cphHeaderContent_find_location_distance").change(function () {
			                $(this).siblings("ul").find("li").removeClass("selected").has("span:contains(" + $(this).val() + ")").addClass("selected");
			            });
			        }
			    },
			    getUL: function () {
