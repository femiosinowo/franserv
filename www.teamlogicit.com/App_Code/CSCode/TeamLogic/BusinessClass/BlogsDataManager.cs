...
namespace TeamLogic.CMS
{
    ...
    {
        private static string rssFeedUrl = "http://www.itinflections.com/feed/";
        ...
        public static List<Blog> GetRssFeed(int count = 2)
        {
            ...
            try
            {
                string cacheKey = "SirSpeedy-MarketingTangoBlogs" + count;
        ...
        public static List<Blog> GetRssFeedByCategoryName(string CategoryName, int count = 2)
        {
            ...
            if (!string.IsNullOrEmpty(CategoryName))
            {
                ...
                try
                {
                    string cacheKey = "SirSpeedy-MarketingTangoBlogs" + catName;
                    bool dataExistInCache = ApplicationCache.IsExist(cacheKey);
