...
namespace TeamLogic.CMS
{
    ...
    public class AdminToolManager
    {
        ...
        public static List<CountryData> GetAllCountryList()
        {
            ...
            try
            {
                string cacheKey = "SirSpeedy-AllCountryDataFromdb";
		...
		public static bool IsCenterExist(string centerId)
        {
            ...
            {
                int count = 0;
                string adminToolConnectionString = ConfigurationManager.ConnectionStrings["SirSpeedyAdminTool.DbConnection"].ConnectionString;
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
            ...
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    ...
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        ...
                        sqlCommand.Parameters.Add("@Center_Client_Login_Url", SqlDbType.NVarChar).Value = clientLoginUrl;
                        sqlCommand.Parameters.Add("@Center_RequestConsultation_Email", SqlDbType.NVarChar).Value = requestConsultationEmail;
                        sqlCommand.Parameters.Add("@Consultation_Message_Id", SqlDbType.NVarChar).Value =
        ...
        public static int UpdateProductAndServices(string centerId, string productServicesXml)
        {
            ...
            try
            {
                ...
                if (status <= 0)
                {
                    ...
                    {
                        //first record
                        string insertQuery = "insert into Center_Workarea_Data values ('" + centerId + "', '0','0','0','0', '0', '0','" + productServicesXml + "','0','0', '0', '0', '0', '0')";
                        using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                        {
                            sqlCommand.CommandText = insertQuery;
                            sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int UpdateCaseStudyIds(string centerId, string caseStudyIds)
        {
            ...
            try
            {
                ...
                if (status <= 0)
                {
                    ...
                    {
                        //first record
                        string insertQuery = "insert into Center_Workarea_Data values ('" + centerId + "', '0','0','0','0', '" + caseStudyIds + "', '0', '" + null + "','0','0','0', '0', '0', '0')";
                        using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                        {
                            sqlCommand.CommandText = insertQuery;
                            sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int UpdatePartnersIds(string centerId, string partnersIds)
        {
            ...
            try
            {
                ...
                if (status <= 0)
                {
                    ...
                    {
                        //first record
                        string insertQuery = "insert into Center_Workarea_Data values ('" + centerId + "', '0','0','" + partnersIds + "','0', '0', '0', '" + null + "','0','0','0', '0', '0', '0')";
                        using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                        {
                            sqlCommand.CommandText = insertQuery;
                            sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int UpdateThirdPartyData(string centerId, string flickrUserId, string twitterFeedUrl, string  socialMediaXml)
        {
            ...
            try
            {
                ...
                if (centerId == "" || twitterFeedUrl == "" || socialMediaXml == "")
                    return -1;
        ...
        public static int UpdateShopIds(string centerId, string shopIds)
        {
            ...
            try
            {
				...
				if (status <= 0)
                {
                    ...
                    {
                        //first record
                        string insertQuery = "insert into Center_Workarea_Data values ('" + centerId + "', '0','0','0','0', '0', '0', '" + null + "','0','" + shopIds + "','0', '0', '0', '0')";
                        using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                        {
                            sqlCommand.CommandText = insertQuery;
                            sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int UpdateManageITIds(string centerId, string manageITContentIds)
        {
            int status = -1;
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string query = "update Center_Workarea_Data set Center_ManageITServices_Ids = '" + manageITContentIds + "' where Center_Id = '" + centerId + "'";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = query;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
                ...
                if (status <= 0)
                {
                    ...
                    {
                        //first record
                        string insertQuery = "insert into Center_Workarea_Data values ('" + centerId + "', '0','0','0','0', '0', '0', '" + null + "','0','0','" + manageITContentIds + "', '0', '0', '0')";
                        using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                        {
                            sqlCommand.CommandText = insertQuery;
                            sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int UpdateITSolutionIds(string centerId, string ITSolutionContentIds)
        {
            int status = -1;
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string query = "update Center_Workarea_Data set Center_ITSolution_Ids = '" + ITSolutionContentIds + "' where Center_Id = '" + centerId + "'";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = query;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
                ...
                if (status <= 0)
                {
                    ...
                    {
                        //first record
                        string insertQuery = "insert into Center_Workarea_Data values ('" + centerId + "', '0','0','0','0', '0', '0', '" + null + "','0','0','0', '" + ITSolutionContentIds + "', '0', '0')";
                        using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                        {
                            sqlCommand.CommandText = insertQuery;
                            sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int UpdateProjectExpertsIds(string centerId, string projectExpertsContentIds)
        {
            int status = -1;
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string query = "update Center_Workarea_Data set Center_ProjectExperts_Ids = '" + projectExpertsContentIds + "' where Center_Id = '" + centerId + "'";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = query;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
                ...
                if (status <= 0)
                {
                    ...
                    {
                        //first record
                        string insertQuery = "insert into Center_Workarea_Data values ('" + centerId + "', '0','0','0','0', '0', '0', '" + null + "','0','0','0', '0', '" + projectExpertsContentIds + "', '0')";
                        using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                        {
                            sqlCommand.CommandText = insertQuery;
                            sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int UpdateITOurSolutionIds(string centerId, string ITOurSolutionContentIds)
        {
            int status = -1;
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string query = "update Center_Workarea_Data set Center_ITOurSolution_Ids = '" + ITOurSolutionContentIds + "' where Center_Id = '" + centerId + "'";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = query;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
                ...
                if (status <= 0)
                {
                    ...
                    {
                        //first record
                        string insertQuery = "insert into Center_Workarea_Data values ('" + centerId + "', '0','0','0','0', '0', '0', '" + null + "','0','0','0', '0', '0', '" + ITOurSolutionContentIds + "')";
                        using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                        {
                            sqlCommand.CommandText = insertQuery;
                            sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static AdminScreenPermissions GetUserPermission(string userRole, string username, bool refresh =false)
        {
            ...
            try
            {
                string cacheKey = "SirSpeedy-FransWorkareaData" + username;
                bool dataExistInCache = ApplicationCache.IsExist(cacheKey);
                        ...
                        if (reader != null && reader.HasRows)
                        {
                            ...
                            while (reader.Read())
                            {
                                ...
                                if (reader.GetValue(11) != null)
                                    item.UploadedFileId = FormateDMSId(reader.GetValue(11).ToString());
        ...
        public static int DeleteSendAFileRecord(long sFileId)
        {
            ...
            if (sFileId > 0)
            {
                try
                {
                    using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                    {
                        string query = "delete from Center_Send_A_File where Quote_Id = " + sFileId + "";
                        using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                        {
                            sqlCommand.CommandText = query;
                            sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int AddUpdateWhyWeAreDiffContent(WhyWeAreDiff data)
        {
            ...
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string query = "update Why_We_Diff_Content set Banner_Title ='" + data.BannerTitle + "', Banner_SubTitle= '" + data.BannerSubTitle + "', Content_Title= '" + data.ContentTitle + "', Content_TagLine= '" + data.ContentTagLine + "', Content_Description= '" + data.ContentDescription + "', Video_Link='" + data.VideoLink + "', Video_Statement_Text='" + data.VideoStatementText + "', Date_Modified = '" + DateTime.Now + "' where Center_Id ='" + data.CenterId + "'";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = query;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
                ...
                if (status <= 0)
                {
                    using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                    {                        
                        string insertQuery = "insert into Why_We_Diff_Content values ('"+data.CenterId+"', '"+data.BannerTitle+"', '"+data.BannerSubTitle+"', '"+data.ContentTitle+"', '"+data.ContentTagLine+"', '"+data.ContentDescription+"', '"+data.VideoLink+"', '"+data.VideoStatementText+"', '"+DateTime.Now+"', '"+DateTime.Now+"')";
                        using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                        {
                            sqlCommand.CommandText = insertQuery;
                            sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int AddTestimonial(Testimonials data)
        {
            ...
            try
            {
                int isAboutUs = data.IsAboutUs == true ? 1 : 0;
                int isManageIT = data.IsManageIT == true ? 1 : 0;
                int isProjectExpert = data.IsProjectExpert == true ? 1 : 0;

                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string insertQuery = "insert into Testimonials values ('" + data.Center_Id + "', '" + data.Statement + "', '" + data.FirstName + "', '" + data.LastName + "', '" + data.Organization + "', '" + DateTime.Now + "', '" + data.Title + "', '" + DateTime.Now + "', '" + data.PicturePath + "', " + 0 + ", " + isAboutUs + ", " + isManageIT + ", " + isProjectExpert + ", '" + data.PhoneNumber + "', '" + data.EmailAddress + "')";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = insertQuery;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int UpdateTestimonial(Testimonials data)
        {
            ...
            try
            {
                ...
                {
                    int national = 0;
                    if (data.IsNational != null && data.IsNational == true)
                        national = 1;

                    string insertQuery = "update Testimonials set Testimonial='" + data.Statement + "', FirstName='" + data.FirstName + "', LastName='" + data.LastName + "', Organization='" + data.Organization + "', Title='" + data.Title + "', Date_Modified='" + DateTime.Now + "', Testimonial_Image='" + data.PicturePath + "', IsNational = '" + national + "', PhoneNumber= '" + data.PhoneNumber + "', EmailAddress = '" + data.EmailAddress + "' where id = '" + data.TestimonialId + "'";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = insertQuery;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int UpdateLocalTestimonial(Testimonials data)
        {
            int status = -1;
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    ...
                    if (data.IsNational != null && data.IsNational == true)
                        national = 1;
                    if (data.IsAboutUs != null && data.IsAboutUs == true)
                        about = 1;
                    if (data.IsManageIT != null && data.IsManageIT == true)
                        manageIT = 1;
                    if (data.IsProjectExpert != null && data.IsProjectExpert == true)
                        projectExpert = 1;

                    string insertQuery = "update Testimonials set Testimonial='" + data.Statement + "', FirstName='" + data.FirstName + "', LastName='" + data.LastName + "', Organization='" + data.Organization + "', Title='" + data.Title + "', Date_Modified='" + DateTime.Now + "', Testimonial_Image='" + data.PicturePath + "', IsAboutUs = '" + about + "', IsManageIT = '" + manageIT + "', IsProjectExpert = '" + projectExpert + "', IsNational ='"+ national+ "', PhoneNumber= '" + data.PhoneNumber + "', EmailAddress = '"+ data.EmailAddress+  "' where id = '" + data.TestimonialId + "'";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = insertQuery;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static bool CloneCenter(string selectedCenter, string currentCenter)
        {
            ...
            try
            {
                ...
                //Complete Solution/IT Solution
                var existingITSolutionList = AdminToolManager.GetAvailableITSolutions(selectedCenter);
                if (existingITSolutionList != null && existingITSolutionList.Any())
                {                
                    sb = new StringBuilder();
                    foreach (var s in existingITSolutionList)
                        sb.Append(s + ",");
                    UpdateAvailableITSolutions(currentCenter, sb.ToString());
                }

                //Our Solution/Featured Solution
                var existingFeaturedSolutionsList = AdminToolManager.GetAvailableFeaturedSolutions(selectedCenter);
                if (existingFeaturedSolutionsList != null && existingFeaturedSolutionsList.Any())
                { 
                    sb = new StringBuilder();
                    foreach (var s in existingFeaturedSolutionsList)
                        sb.Append(s + ",");
                    UpdateAvailableFeatureSolutions(currentCenter, sb.ToString());
                }

                //Manage Consulting Project
                var existingConsultingProjectList = AdminToolManager.GetAvailableConsultingProject(selectedCenter);
                if (existingConsultingProjectList != null && existingConsultingProjectList.Any())
                {
                    sb = new StringBuilder();
                    foreach (var c in existingConsultingProjectList)
                        sb.Append(c + ",");
                    UpdateAvailableConsultingProject(currentCenter, sb.ToString());
                }
        ...
        public static List<ConsultationRequest> GetAllCenterConsultationRequest(string centerId)
        {
            List<ConsultationRequest> list = new List<ConsultationRequest>();
            if (!string.IsNullOrEmpty(centerId))
            {
                try
                {
                    using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                    {
                        string procName = "Get_All_Active_Consultation_Requests";
                        using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                        {
                            sqlCommand.CommandText = procName;
                            sqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                            ...
                            while (reader.Read())
                            {
                                ...
                                {
                                    ConsultationRequestId = reader["S_Id"] is DBNull ? 0 : long.Parse(reader["S_Id"].ToString()),
                                    CenterId = reader["Center_Id"] is DBNull ? null : reader["Center_Id"].ToString(),
                                    FirstName = reader["First_Name"] is DBNull ? null : reader["First_Name"].ToString(),
                                    LastName = reader["Last_Name"] is DBNull ? null : reader["Last_Name"].ToString(),
                                    Email = reader["Email_Address"] is DBNull ? null : reader["Email_Address"].ToString(),
                                    Company = reader["Company"] is DBNull ? null : reader["Company"].ToString(),
                                    Phone = reader["Phone"] is DBNull ? null : reader["Phone"].ToString(),
                                    HowCanWeHelp = reader["HowCanWeHelp"] is DBNull ? null : reader["HowCanWeHelp"].ToString(),
                                    DatePosted = reader["Date_Submitted"] is DBNull ? DateTime.MinValue : DateTime.Parse(reader["Date_Submitted"].ToString())
                                };
                                list.Add(cr);
                            }
        ...
        public static int DeleteConsultationRequest(long sId)
        {
            int status = -1;
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string query = "Delete from Center_User_Consultation_Request where S_Id = " + sId + "";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = query;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static bool UpdateShopContentURL(string centerId, long contentId, string url)
        {
            bool status = false;
            try
            {
                ...
                if (count <= 0)
                {
                    using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                    {
                        string insertQuery = "Insert into Center_Shop_Data values('" + centerId + "', " + contentId + ", '" + url + "')";
                        using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                        {
                            sqlCommand.CommandText = insertQuery;
                            sqlCommand.CommandType = System.Data.CommandType.Text;
                ...
                else
                {
                    using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                    {
                        string insertQuery = "update Center_Shop_Data set Shop_URL = '" + url + "' where Shop_Content_Id = " + contentId + " and Center_id = '" + centerId + "'";
                        using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                        {
                            sqlCommand.CommandText = insertQuery;
                            sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static List<JobPost> GetAllJobs()
        {
            ...
            try
            {
                ...
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string procName = "Get_All_Center_Jobs";
        ...
        public static List<long> GetAvailableITSolutions(string centerId)
        {
            List<long> selectedITSolutionList = null;
            string result = "";
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string query = "select Selected_IT_Solution_Ids from Center_Avaliable_IT_SolutionIds where Center_Id = '" + centerId + "'";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = query;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
                        ...
                        if (reader != null && reader.HasRows)
                        {
                            ...
                            if (result != "")
                            {
                                selectedITSolutionList = new List<long>();
                                var stringIds = result.Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
                                if (stringIds != null && stringIds.Length > 0)
                                {
                                    foreach (var sId in stringIds)
                                    {
                                        ...
                                        long.TryParse(sId, out cId);
                                        if (cId > 0)
                                            selectedITSolutionList.Add(cId);
                                    }
                                }
                            }
                        }
            ...
            return selectedITSolutionList;
        }

        public static bool IsITSolutionsAssigned(string centerId)
        {
            bool status = false;
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string insertQuery = "select count(*) from Center_Avaliable_IT_SolutionIds where Center_Id = '" + centerId + "'";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = insertQuery;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int AddAvailableITSolutions(string centerId, string itSolutionCids)
        {
            int status = -1;
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string insertQuery = "insert into Center_Avaliable_IT_SolutionIds values ('" + centerId + "', '" + itSolutionCids + "')";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = insertQuery;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int UpdateAvailableITSolutions(string centerId, string itSolutionCids)
        {
            int status = -1;
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string insertQuery = "update Center_Avaliable_IT_SolutionIds set Selected_IT_Solution_Ids='" + itSolutionCids + "' where Center_Id = '" + centerId + "'";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = insertQuery;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static List<long> GetAvailableFeaturedSolutions(string centerId)
        {
            List<long> selectedFeaturedSolutionList = null;
            string result = "";
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string query = "select Selected_Featured_Solution_Ids from Center_Avaliable_Featured_SolutionIds where Center_Id = '" + centerId + "'";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = query;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
                        ...
                        if (reader != null && reader.HasRows)
                        {
                            ...
                            if (result != "")
                            {
                                selectedFeaturedSolutionList = new List<long>();
                                var stringIds = result.Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
                                if (stringIds != null && stringIds.Length > 0)
                                {
                                    foreach (var sId in stringIds)
                                    {
                                        ...
                                        long.TryParse(sId, out cId);
                                        if (cId > 0)
                                            selectedFeaturedSolutionList.Add(cId);
                                    }
                                }
                            }
                        }
            ...
            return selectedFeaturedSolutionList;
        }

        public static bool IsFeaturedSolutionsAssigned(string centerId)
        {
            bool status = false;
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string insertQuery = "select count(*) from Center_Avaliable_Featured_SolutionIds where Center_Id = '" + centerId + "'";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = insertQuery;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int AddAvailableFeaturedSolutions(string centerId, string featuredSolutionCids)
        {
            int status = -1;
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string insertQuery = "insert into Center_Avaliable_Featured_SolutionIds values ('" + centerId + "', '" + featuredSolutionCids + "')";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = insertQuery;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int UpdateAvailableFeatureSolutions(string centerId, string featuredSolutionCids)
        {
            int status = -1;
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string insertQuery = "update Center_Avaliable_Featured_SolutionIds set Selected_Featured_Solution_Ids='" + featuredSolutionCids + "' where Center_Id = '" + centerId + "'";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = insertQuery;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static List<long> GetAvailableConsultingProject(string centerId)
        {
            List<long> selectedConsultingProjectList = null;
            string result = "";
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string query = "select Selected_Consulting_Project_Ids from Center_Avaliable_Consulting_ProjectIds where Center_Id = '" + centerId + "'";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = query;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
                        ...
                        if (reader != null && reader.HasRows)
                        {
                            ...
                            if (result != "")
                            {
                                selectedConsultingProjectList = new List<long>();
                                var stringIds = result.Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
                                if (stringIds != null && stringIds.Length > 0)
                                {
                                    foreach (var sId in stringIds)
                                    {
                                        ...
                                        long.TryParse(sId, out cId);
                                        if (cId > 0)
                                            selectedConsultingProjectList.Add(cId);
                                    }
                                }
                            }
                        }
            ...
            return selectedConsultingProjectList;
        }

        public static bool IsConsultingProjectAssigned(string centerId)
        {
            bool status = false;
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string insertQuery = "select count(*) from Center_Avaliable_Consulting_ProjectIds where Center_Id = '" + centerId + "'";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = insertQuery;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int AddAvailableConsultingProject(string centerId, string consultingProjectCids)
        {
            int status = -1;
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string insertQuery = "insert into Center_Avaliable_Consulting_ProjectIds values ('" + centerId + "', '" + consultingProjectCids + "')";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = insertQuery;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        public static int UpdateAvailableConsultingProject(string centerId, string consultingProjectCids)
        {
            int status = -1;
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string insertQuery = "update Center_Avaliable_Consulting_ProjectIds set Selected_Consulting_Project_Ids='" + consultingProjectCids + "' where Center_Id = '" + centerId + "'";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = insertQuery;
                        sqlCommand.CommandType = System.Data.CommandType.Text;
        ...
        /// <summary>
        /// This method is used to get request consultation data
        /// </summary>
        /// <param name="centerId">centerId</param>
        /// <returns></returns>
        public static List<RequestConsultationWording> GetAllRequestConsultationText(string centerId)
        {
            List<RequestConsultationWording> requestConsultationWordingsList = new List<RequestConsultationWording>();
            //if (!string.IsNullOrEmpty(centerId))
            {
                try
                {
                    string cacheKey = "SirSpeedy-Get_All_ConsultationContent" + centerId;
                    bool dataExistInCache = ApplicationCache.IsExist(cacheKey);
                    ...
                    if (!dataExistInCache)
                    {
                        using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                        {
                            string procName = "Get_All_Consultation";
                            ...
                            using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                            {
                                ...
                                while (reader.Read())
                                {
                                    var requestWording = new RequestConsultationWording()
                                    {
                                        Title = reader["Consultation_Title"] is DBNull ? null : reader["Consultation_Title"].ToString(),
                                        ConsultationText = reader["Consultation_Text"] is DBNull ? null : reader["Consultation_Text"].ToString(),
                                        Consultation_Id = reader["Consultation_Id"] is DBNull ? -1 : Convert.ToInt32(reader["Consultation_Id"]),
                                        CenterId = reader["Center_Id"] is DBNull ? null : reader["Center_Id"].ToString(),
                                    };
                                    requestConsultationWordingsList.Add(requestWording);
                                }
                            }
                        }
                        if (requestConsultationWordingsList.Any())
                            ApplicationCache.Insert(cacheKey, requestConsultationWordingsList, ConfigHelper.GetValueLong("smallCacheInterval"));
                    }
                    else
                    {
                        var cacheData = ApplicationCache.GetValue(cacheKey);
                        if (cacheData != null)
                            requestConsultationWordingsList = (List<RequestConsultationWording>)cacheData;
                    }
                }
                catch (Exception ex)
                {
            ...
            return requestConsultationWordingsList;
        }

        public static bool UpdateConsultationWording(string Center_Id, int Consultation_Id, string Consultation_Text, string Consultation_Title)
        {
            bool status = false;
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(adminToolConnectionString))
                {
                    string procName = "Save_Consultation_Wording";
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        sqlCommand.CommandText = procName;
                        sqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                        sqlCommand.Parameters.Clear();
                        sqlCommand.Parameters.Add("@CenterId", SqlDbType.NVarChar).Value = Center_Id;
                        sqlCommand.Parameters.Add("@Consultation_Id", SqlDbType.Int).Value = Consultation_Id;
                        sqlCommand.Parameters.Add("@Consultation_Text", SqlDbType.NVarChar).Value = Consultation_Text;
                        sqlCommand.Parameters.Add("@Consultation_Title", SqlDbType.NVarChar).Value = Consultation_Title;
