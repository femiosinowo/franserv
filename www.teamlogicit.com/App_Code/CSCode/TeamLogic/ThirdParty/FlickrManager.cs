                ...
                if (!dataExistInCache)
                {
                    if (!string.IsNullOrEmpty(userId))
                    {
                        ...
                        if (setList != null && setList.Any())
                            ApplicationCache.Insert(cacheKey, setList, ConfigHelper.GetValueLong("smallCacheInterval"));
                    }
                }
                else
                {
                ...
                try
                {
                    ...
                    if (!dataExistInCache)
                    {
                        ...
                        if (photoSetData != null)
                            ApplicationCache.Insert(cacheKey, photoSetData, ConfigHelper.GetValueLong("smallCacheInterval"));
                    }
                    else
                    {
                        var cacheData = ApplicationCache.GetValue(cacheKey);
