        ...
        <table>
            <tbody>
                ...
                <tr>
                    <td class="CS_Form_Required_Baseline"><span class="CS_Form_Required_Baseline">
                        <strong>
                            <label for="txtStatement">Shop Content URL stating with "http://":</label></strong></span></td>
                    <td>
                        <asp:TextBox runat="server" PlaceHolder="http://wwww.example.com/" Width="300" ID="txtLink" />
                ...
                <tr>
                    <td class="CS_Form_Required_Baseline"><span class="CS_Form_Required_Baseline">
                        <label for="txtStatement">Is Active to show on web site:</label></span></td>
                    <td>
