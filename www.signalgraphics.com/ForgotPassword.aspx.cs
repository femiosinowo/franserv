...
public partial class ForgotPassword : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Write("Recovery Password has been sent to your email address");
        }
    }
    ...
    protected UserData isEmailAvailable(string email)
    {
        ...
        try
        {
            ...
            if (udata1 != null && udata1.Id > 0)
            {
                ...
                string newPassword = uMngr.ResetPassword(email);
                ...
                sendRecoveryPassword(udata1.Email, newPassword);
                return udata1;
            }
            else
            {
    ...
    private void sendRecoveryPassword(string email, string password)
    {
        ...
        string sendTo = email;
        string emailSubject = "Your Signal Graphics Account's Recovery Password";
        ...
        try
        {
            ...
            Utility.SendEmail(sendTo, sendFrom, "", emailContent, emailSubject);
