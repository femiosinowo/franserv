...
$(document).ready(function () {
    ...
    $('#find_location_page_submit').click(function (e) {
        ...
        if (validation) {
            ...
            var distance = $('.findLocationSearchForm ul.transformSelect li').eq('0').find('span:first').text();
    ...
    function fnDoValidationForLocation() {       
        ...
        var distanceVal = $('.findLocationSearchForm ul.transformSelect li').eq('0').find('span:first').text();
    ...
    function LoadLocationMapData(initialLoad, locationsData) {       
        ...
        markerImg = '/images/locations/find-location-map-marker.png';
        markerImgActive = '/images/locations/find-location-map-marker-active.png';
        ...
        if (locationsArray) {
            ...
            for (var i = 0; i < locationsArray.length; i++) {
                ...
                markerData = new google.maps.Marker({
                    position: pos,
                    map: mapData,
                    icon: 'https://chart.googleapis.com/chart?chst=d_map_pin_letter&chld=' + '|e82b36|000000',
                });
