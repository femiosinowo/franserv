...
public partial class case_studies_details : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            Scribd.Net.Service.APIKey = "c7u1imkq39o134s8zr31wcvk9syc3w";
            Scribd.Net.Service.SecretKey = "sec-2e08n4ky9hjkus5antop0qirml";
            Scribd.Net.Service.PublisherID = "pub-83959316942158191071442065";
            Session["signedin"] = Scribd.Net.User.Login("Signalgraphicsprint", "obi3-produce").ToString();
