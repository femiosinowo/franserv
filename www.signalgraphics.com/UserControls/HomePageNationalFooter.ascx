...
<%@ OutputCache Duration="21600" VaryByParam="None" VaryByCustom="HomePageNationalFooter" %>
                                            ...
                                            <ItemTemplate>
                                                <div class="item blog">
                                                    ...
                                                    <div class="item-desc">
                                                        ...
                                                        <p>
                                                            <%# Eval("Description") %></p>
                                                        <div class="cta-button-wrap more-btn">
                                                            <a target="_blank" href="<%# Eval("MoreLink") %>" class="cta-button-text"><span>More</span></a></div>
                                                    </div>
                                                    <!-- end .item-desc -->
                                                </div>
                                                <!-- end item -->
