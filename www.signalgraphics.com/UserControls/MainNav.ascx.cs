...
public partial class UserControls_MainNav : UserControl
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        cbHistoryText.DefaultContentID = ConfigHelper.GetValueLong("MegaMenuHistoryPlaceHolderImgCId");
    ...
    {
        string cacheKey = String.Format("SignalGraphics:UserControls_MainNav:GetPSMMContent:FranchiseId={0}",
            _fransId);
    ...
    {
        string cacheKey = String.Format("SignalGraphics:UserControls_MainNav:GetPSMMSideContent:FranchiseId={0}",
            _fransId);
    ...
    private DataTable GetCompanyInfoContent()
    {
        ...
        string cacheKey = String.Format("SignalGraphics:UserControls_MainNav:GetCompanyInfoContent:FranchiseId={0}",
            _fransId);
    ...
    private DataTable GetManagementTeamContent()
    {
        ...
        string cacheKey = String.Format("SignalGraphics:UserControls_MainNav:GetManagementTeamContent:FranchiseId={0}",
            _fransId);
    ...
    private DataTable GetManagementTeamContentForLocal()
    {
        ...
        string cacheKey = String.Format("SignalGraphics:UserControls_MainNav:GetManagementTeamContentForLocal:FranchiseId={0}",
            _fransId);
    ...
    private DataTable GetNewsContent()
    {
        ...
        string cacheKey = String.Format("SignalGraphics:UserControls_MainNav:GetNewsContent:FranchiseId={0}",
            _fransId);
    ...
    private DataTable GetPartnersContent()
    {
        ...
        string cacheKey = String.Format("SignalGraphics:UserControls_MainNav:GetPartnersContent:FranchiseId={0}",
            _fransId);
    ...
    private DataTable GetInTheMediaContent()
    {
        ...
        string cacheKey = String.Format("SignalGraphics:UserControls_MainNav:GetInTheMediaContent:FranchiseId={0}",
            _fransId);
    ...
    private DataTable GetBriefsWHitepaperContent()
    {
        ...
        string cacheKey = String.Format("SignalGraphics:UserControls_MainNav:GetBriefsWHitepaperContent:FranchiseId={0}",
            _fransId);
    ...
    private DataTable GetCaseStudiesContent(int count)
    {
        ...
        string cacheKey = String.Format("SignalGraphics:UserControls_MainNav:GetCaseStudiesContent:FranchiseId={0}:Count={1}",
            _fransId, count);
    ...
    private DataTable GetJoinOurTeamContent()
    {
        ...
        string cacheKey = String.Format("SignalGraphics:UserControls_MainNav:GetJoinOurTeamContent:FranchiseId={0}",
            _fransId);
    ...
    {
        MenuData data = null;
        string cacheKey = String.Format("SignalGraphics:UserControls_MainNav:GetMenuData:FranchiseId={0}{1}",
            _fransId, navId);
