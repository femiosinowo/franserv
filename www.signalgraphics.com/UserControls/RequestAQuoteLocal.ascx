...
<script type="text/javascript">
    $(document).ready(function () {
        $('.btnRequestQuoteLocal').click(function (e) {
            var status = false;
            var status1 = false;
            var status2 = false;
            ...
            var description = $('.desc_project').val();
            if (description != "") {
    ...
    function SendRAQData() {
        ...
        var phoneNumber = document.getElementById('<%=phone.ClientID%>').value;
        var jobTitle = document.getElementById('<%=txtJobTitle.ClientID%>').value;
        var companyName = document.getElementById('<%=company.ClientID%>').value;
        var projectName = document.getElementById('<%=pname.ClientID%>').value;
        var projectBudget = document.getElementById('<%=txtProjectBudget.ClientID%>').value;
        var projectDescription = document.getElementById('<%=descProject.ClientID%>').value;
...
<div class="request_quote_tagline">
    ...
    <div class="grid_4">
        ...
        <div class="form" id="request_quote_local_submit">
             <asp:Button ID="btnRequestQuoteLocal" CssClass="red_btn btnRequestQuoteLocal" runat="server"
