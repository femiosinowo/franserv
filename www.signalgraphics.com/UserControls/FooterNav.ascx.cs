...
public partial class UserControls_FooterNav : System.Web.UI.UserControl
{
    ...
    {
        string cacheKey = String.Format("SignalGraphics:UserControls_FooterNav:GetPSNationalContent:FranchiseId={0}",
            _fransId);
    ...
    {
        MenuData data = null;
        string cacheKey = String.Format("SignalGraphics:UserControls_FooterNav:GetMenuData:FranchiseId={0}{1}",
