...
public partial class UserControls_JoinOurTeamDepartmentSlider : System.Web.UI.UserControl
{
    ...
    private DataTable GetJoinOurTeamContent()
    {
        ...
        string cacheKey = String.Format("SignalGraphics:UserControlsJoinOurTeamDepartmentSlider:GetJoinOurTeamContent:FolderID={0}:SmartFormXMLConfig={1}:FranchiseId={2}", folderID, SmartFormXMLConfig, fransId);
