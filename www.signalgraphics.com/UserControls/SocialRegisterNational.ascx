        ...
        <div class="prefix_1 grid_22 suffix_1 alpha guest_register_saf">
            ...
            <div class="form" id="socialReg_choose_center">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtRegisterLocation"
                    CssClass="required" ValidationGroup="SocialRegister"></asp:RequiredFieldValidator>
                ...
                <div Style="display: none;">
                     <asp:TextBox ID="txtRegisterChooseLocation" Text="" CssClass="txtRegisterChooseLocation required"
                    runat="server"></asp:TextBox>
                </div>                               
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtRegisterChooseLocation"
                    ErrorMessage="Choose a Center." CssClass="required" ValidationGroup="SocialRegister">*</asp:RequiredFieldValidator>
                <div class="clear">
                </div>
            ...
            <div class="form" id="contact_project_info">
                ...
                <p>
                    ...
                    <asp:RequiredFieldValidator ID="rfv3" runat="server" ControlToValidate="phone" CssClass="required"
                        ErrorMessage="Phone Number is required." ValidationGroup="SocialRegister" ForeColor="Red">*</asp:RequiredFieldValidator>
                </p>
                ...
                <p>
                    ...
                    <%--<asp:RequiredFieldValidator ID="rfv4" runat="server" ControlToValidate="job_title"
                        ErrorMessage="Job Title is required." CssClass="required" ValidationGroup="SocialRegister" ForeColor="Red">*</asp:RequiredFieldValidator>--%>
                </p>
                <p>
                    ...
                    <%--<asp:RequiredFieldValidator ID="rfv5" runat="server" ControlToValidate="company"
                        ErrorMessage="Company is required." CssClass="required" ValidationGroup="SocialRegister" ForeColor="Red">*</asp:RequiredFieldValidator>--%>
                </p>
                <p>
                    ...
                    <asp:RequiredFieldValidator ID="rfv6" runat="server" ControlToValidate="website"
                        ErrorMessage="Website is required." CssClass="required" ValidationGroup="SocialRegister" ForeColor="Red">*</asp:RequiredFieldValidator>
                </p>
                <hr />
                <h3>
                ...
                <div class="sf_project_desc">
                    ...
                    <asp:RequiredFieldValidator ID="rfv7" runat="server" ControlToValidate="project_name"
                        ErrorMessage="Project Name is required." CssClass="required" ValidationGroup="SocialRegister" ForeColor="Red">*</asp:RequiredFieldValidator>
                    <div class="grid_11 suffix_1 form_two_col">
                        ...
                        <asp:TextBox ID="project_quantity" runat="server" CssClass="required" placeholder="Quantity*" Width="59%"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfv8" runat="server" ControlToValidate="project_name"
                            ErrorMessage="Quantity is required." CssClass="required" ValidationGroup="SocialRegister" ForeColor="Red">*</asp:RequiredFieldValidator>
                    </div>
              ...
              <%--           <asp:TextBox ID="project_due_date" runat="server" CssClass="required" required="required" placeholder="Due Date*" Visible="False"></asp:TextBox>
                ...
                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" Style="margin: 0px;" ForeColor="Red" CssClass="required" runat="server" ControlToValidate="txtUploadFiles"
                     ErrorMessage="Select a file to upload." ValidationGroup="SocialRegister">*</asp:RequiredFieldValidator>--%>
