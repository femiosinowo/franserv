<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RequestAQuoteNational.ascx.cs" Inherits="UserControls_RequestAQuoteNational" %>
...
<script type="text/javascript">
        ...
        $('.btnRequestQuote').click(function (e) {
            ...
            $('.raq input.required').each(function () {
                ...
                if (fieldVal != '') {
                    ...
                    status = false; //alert($(this).attr('id')); 
    ...
    function SendRAQData() {
        var firstName = document.getElementById('<%=fnameNational.ClientID%>').value;
            var lastName = document.getElementById('<%=lnameNational.ClientID%>').value;
            var emailAddress = document.getElementById('<%=emailNational.ClientID%>').value;
            var selectedCenter = $('.hdnTxtChooseCenter').val();
            var phoneNumber = document.getElementById('<%=phoneNational.ClientID%>').value;
            var jobTitle = document.getElementById('<%=jobTitleNational.ClientID%>').value;
            var companyName = document.getElementById('<%=companyNational.ClientID%>').value;
            var projectName = document.getElementById('<%=pnameNational.ClientID%>').value;
            var projectBudget = document.getElementById('<%=txtProjectBudget.ClientID%>').value;
            var projectDescription = document.getElementById('<%=descProjectNational.ClientID%>').value;
    ...
    <div class="request_quote">
        ...
        <div class="clearfix rq_form_body">
            <div class="form" id="choose_center">
                <asp:TextBox ID="hdnTxtChooseCenter" ValidationGroup="requestQuote" CssClass="hdnTxtChooseCenter required" Style="display: none;" runat="server" />
                ...
                <input type="text" placeholder="Enter City, State, Zip" id="location" />
                ...
                <span class="required">*</span>
                <div class="clear"></div>
                <input class="red_btn search_location_requestQuote" type="submit" id="search_location" value="Search" />
            ...
            <div class="clear"></div>
            <p id="viewQuoteMapError" style="display:none; color:red;">Please select a center.</p>
            <div id="rq_pick_location" style="display: none" class="clearfix">
                <input id="viewDirectionQuoteDesktop" type="hidden" class="viewDirectionQuoteDesktop" runat="server" value="" />
                <input id="viewDirectionQuoteMobile" type="hidden" class="viewDirectionQuoteMobile" runat="server" value="" />
                <h3>Pick a Location       
                 <div class="cta-button-wrap purple small cta-button-wrap-quote view-map">
                        <a class="cta-button-text quote-view-map view-map fancybox iframe" title="Your Location" href="#"><span>View a Map</span></a>
                 </div>
                 <!-- end cta-button-wrap -->
                 <!-- go to google map page on devices smaller than 768px -->
                 <div class="cta-button-wrap gold small view-map-mobile">
                      <a class="cta-button-text quote-view-map" href="#" title="Your Location" target="_blank"><span>View a Map</span></a>
                 </div>
                 <!-- end cta-button-wrap -->
                </h3>                
                <div class="form" id="rq_pick_location_list">
                    <!--The html for the div will be binded using the javascript -->
                    <div id="location_results_scroll" class="custom_form_scroll"></div>
...
mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm -->
<div class="clear"></div>
<div class="request_quote_tagline raq">
    <div class="grid_20">
    ...
    <div class="grid_4">
        ...
        <div class="form" id="request_quote_submit">
            <asp:Button ID="btnRequestQuote" CssClass="red_btn btnRequestQuote" runat="server"
