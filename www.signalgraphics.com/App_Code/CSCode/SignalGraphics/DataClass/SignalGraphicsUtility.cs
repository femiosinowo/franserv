...
{
    /// <summary>
    /// Summary description for SignalGraphicsUtility
    /// </summary>
    public class SignalGraphicsUtility
    {
        ...
        public static string GetModelSiteConfigKey(long id)
        {
            ...
            if (id > 0)
            {
                ...
                string cacheKey = "SignalGraphicsmodelSiteConfigContent";
