<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.master" AutoEventWireup="true" CodeFile="requestaquote.aspx.cs" Inherits="requestaquote" %>
...
<script type="text/javascript">
    ...
    function SendRAQData() {
        ...
        $.ajax({
            ...
            data: '{"firstName": ' + firstName + ',"lastName":' + lastName + ',"emailAddress":"' + emailAddress + '","selectedCenter":"' + selectedCenter + '","phoneNumber":' + phoneNumber + ',"jobTitle": ' + jobTitle + ',"companyName":' + companyName + ',"projectName":' + projectName + ',"projectBudget":' + projectBudget + ',"projectDescription":' + projectDescription + ',"uploadedFilesIds":"' + uploadedFilesIds + '","DueDate":' + duedate + ',"EmailOptIn":' + emailOptIn + ' }',
            contentType: "application/json; charset=utf-8",
            dataType: "text",
            async: false,
            cache: false,
        ...
        <div class="rq_form_body clearfix">
            <div class="form" id="contact_project_info">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="emailVerify" ForeColor="Red" CssClass="required" runat="server" 
                     ValidationGroup="requestQuote"></asp:RequiredFieldValidator>
                <asp:CompareValidator runat="server" ControlToValidate="emailNational" ControlToCompare="emailVerify" Operator="Equal" Type="String" ForeColor="Red" CssClass="required" ValidationGroup="requestQuote"></asp:CompareValidator>
                <span class="required">*</span>
