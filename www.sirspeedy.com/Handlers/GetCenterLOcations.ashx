...
public class GetCenterLOcations : IHttpHandler {
    ...
    private string GetAllLocations()
    {
        ...
        try
        {
            ...
            {
                string cacheKey = "SSFransLocationsByContinents" + reqData.continentCode;
                ...
                if (!dataExistInCache)
                {
                    ...
                    {
                        var getFilteredList = getAllLocations.Where(x => x.ContinentCode == reqData.continentCode && x.FransId.ToLower() != "missionviejoca0002").ToList();
