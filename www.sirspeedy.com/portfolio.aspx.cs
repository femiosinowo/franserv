...
public partial class portfolio : PageBase
{
    ...
    private static string PhotoHtml(string sId)
    {
        ...
        string cacheKey = String.Format("Sirspeedy:portfolio:PhotoHtml:Sid={0}:FranchiseId={1}",
            sId, fransId);
    ...
    {
        string fransId = FransDataManager.IsFranchiseSelected() ? FransDataManager.GetFranchiseId() : "0";
        string cacheKey = String.Format("Sirspeedy:portfolio:GetFirstImageOfAlbum:Sid={0}:FranchiseId={1}",
            sId, fransId);
    ...
    {
        string fransId = FransDataManager.IsFranchiseSelected() ? FransDataManager.GetFranchiseId() : "0";
        string cacheKey = String.Format("Sirspeedy:portfolio:GetFirstImageTitleDesp:Sid={0}:FranchiseId={1}",
            sId, fransId);
