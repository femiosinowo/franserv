...
(function (global, require) {
    ...
    if ('undefined' === typeof (window.Ektron.PathData)) {
        window.Ektron.PathData = {
            "sitePath": settingsObj.sitePath,
            "baseUrl": settingsObj.baseUrl,
            "workareaPath": settingsObj.workareaPath,
            "logoutPath": settingsObj.logoutPath
        };
    }

    if ('undefined' === typeof (parent.Ektron)) {
        parent.Ektron = {};
    }

    if ('undefined' === typeof (parent.Ektron.UX)) {
        ektronRequire(['Vendor/knockout/knockout-mapping', 'UX/js/ux', 'UX/js/toolbar', 'UX/js/apploader', 'UX/js/resourceloader'], function (ko, UX, Toolbar, apploader, ResourceLoader) {
            var toolbar, ux, resourceloader;
            resourceloader = new ResourceLoader('vendor/Ektron/UX');
