        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                if (TwitterConnect.IsAuthorized)
                {
                    ...
                    catch (Exception ex) { Log.WriteError(ex.Message + " " + ex.StackTrace);}
                    ...
                    else if (dt == null && Request.QueryString["oauth_token"] != null && Request.QueryString["oauth_verifier"] != null)
                    {
                        ...
                        else
                        {
                            ...
                            lblError.Text = @"Sorry, an error has occured Authenticating with Twitter credentials";
                            Log.WriteError("Oath Error:" + oauthhelper.oauth_error);
                        }
                    }
                    else
                    {
