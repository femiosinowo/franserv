...
public partial class UserControls_ProductsAndServicesIndexFooterUpper : System.Web.UI.UserControl
{
    ...
    private DataTable GetBriefsWHitepaperContent()
    {
        ...
        string cacheKey = String.Format("Sirspeedy:UserControls_ProductsAndServicesIndexFooterUpper:GetBriefsWHitepaperContent:FranchiseId={0}",
            fransId);
    ...
    {
        string fransId = FransDataManager.IsFranchiseSelected() ? FransDataManager.GetFranchiseId() : "0";
        string cacheKey = String.Format("Sirspeedy:UserControls_ProductsAndServicesIndexFooterUpper:GetBriefsWHitepaperLocalContent:FranchiseId={0}",
            fransId);
