...
public partial class UserControls_ProductAndServicesCategoryIconSlider : System.Web.UI.UserControl
{
    ...
    private DataTable GetPSTopSlider()
    {
        ...
        string cacheKey = String.Format("Sirspeedy:UserControls_ProductAndServicesCategoryIconSlider:GetPSTopSlider:ContentID={0}:CategoryID={1}:FranchiseId={2}", contentSubCategoryID, contentCategoryID, fransId);
