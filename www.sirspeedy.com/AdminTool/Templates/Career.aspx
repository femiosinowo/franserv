<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTool/MasterPages/admin.master" AutoEventWireup="true" CodeFile="Career.aspx.cs" Inherits="AdminTool_Templates_Career" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="AjaxToolkit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="mainCPH" runat="Server">
    <style type="text/css">
        .populateNationalJob input{
         float:left;
        }
        td.CS_Form_Default_Job{
            vertical-align:top;
        }
    </style>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfv2" runat="server" ValidationGroup="AddJob"
                ...
                <tr id="jobPostedDate" runat="server">
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="AddJob"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="AddJob"
        ...
        <table>
            <tr>
                <td class="CS_Form_Required_Baseline">
                    ...
                    <asp:TextBox runat="server" ID="txtJobDescription" TextMode="MultiLine" Columns="80" Rows="50" />
                ...
                <td class="CS_Form_Default_Job">
                    <div id="populateNationalJob" class="populateNationalJob" runat="server" style="padding-left:30px;">
                        <p>To view the job description, click the title. To select the job description, click the radio button to the left.</p>
                        <span class="CS_Form_Required_Baseline">
                        <label for="txtJobDescription">Default Job Descriptions:</label></span><br />
