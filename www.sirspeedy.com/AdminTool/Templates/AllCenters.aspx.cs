    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            if (centerId != string.Empty)
            {
                ...
                if(fransData == null)
                {
                    lblError.Text = "Center does not exist in the system.";
                    return;
                }
                ...
                {
                    lblError.Text = "Sorry, an error has occurred deleting a Center.";
                }
            }
        }
        catch (Exception ex)
        {
            Log.WriteError(ex);
            lblError.Text = "Sorry, an error has occurred processing your request.";
        }
    }
