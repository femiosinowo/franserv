...
<asp:Content ID="Content2" ContentPlaceHolderID="mainCPH" runat="Server">
    ...
    <h3>Manage Center Information</h3>
    <br />       
        ...
        <p class="errorMessage">
         ...
         <div id="tabs">
            <ul class="addCenterTabs">
                <li><a href="#tabs-1">Center Info</a></li>                
                    ...
                    <table width="100%" border="0" cellpadding="2" summary="">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtSAFEmail" runat="server" MaxLength="255" size="50" placeHolder="Send-A-File Email"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtRAQEmail" runat="server" MaxLength="255" size="50" placeHolder="Request a Quote Email"></asp:TextBox>
                            ...
                            <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtWhitePaperDownloadEmail" runat="server" MaxLength="255" size="50" placeHolder="White Paper Download Email"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtJobApplicationEmail" runat="server" MaxLength="255" size="50" placeHolder="Job Application Email"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtSubscriptionEmail" runat="server" MaxLength="255" size="50" placeHolder="Subscription Email"></asp:TextBox>
                    ...
                    <table width="100%" border="0" cellpadding="2" summary="">
                        <tbody>
                            <tr>
                                <td><span>
                                    <strong>
                                        <label for="txtFlickrUserId">Flickr UserId:</label></strong></span></td>
                                <td>
                                    <asp:TextBox ReadOnly="true" ID="txtFlickrUserId" runat="server" MaxLength="255" size="50" placeHolder="Flickr UserId: 123594637@N04"></asp:TextBox>
