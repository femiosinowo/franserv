<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.master" AutoEventWireup="true" CodeFile="guest_register.aspx.cs" 
    Inherits="guest_register" %>
    ...
    <div class="guest_register_content_wrapper clearfix">
        <div class="guest_register_content send_file clearfix main_content">
            <div class="container_24">
               <ux:GuestRegisterNational Visible="false" ID="uxNationalRegister" runat="server" />
               <ux:GuestRegisterLocal Visible="false" ID="uxLocalRegister" runat="server" />
            </div>
            <!-- end container_24  -->
        </div>
