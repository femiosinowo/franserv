...
public partial class case_studies : System.Web.UI.Page
{
    ...
    {
        cbCaseStudiesSideContent.DefaultContentID = ConfigHelper.GetValueLong("CaseStudiesSideContentID");
        cbCaseStudiesSideContent.CacheInterval = ConfigHelper.GetValueLong("longCacheInterval");
        cbCaseStudiesSideContent.Fill();
    ...
    private DataTable GetCaseStudiesContent()
    {
        ...
        string cacheKey = String.Format("Pip:case_studies:GetCaseStudiesContent:FranchiseId={0}",
            fransId);
