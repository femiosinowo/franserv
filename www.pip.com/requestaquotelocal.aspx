<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.master" AutoEventWireup="true" CodeFile="requestaquotelocal.aspx.cs" Inherits="requestaquotelocal" %>
<%@ Register TagPrefix="CMS" Namespace="Ektron.Cms.Controls" Assembly="Ektron.Cms.Controls, Version=9.0.0.249, Culture=neutral, PublicKeyToken=559a2c4fa21e63be" %>

<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" runat="Server">
      <div class="utility_content_wrapper clearfix open">
        <div class="container_24">
            <div class="grid_24">
                <div class="utility_content national" id="request_quote_national" style="display:block">
                 <h1 class="header"> REQUEST A QUOTE </h1>
...
<script type="text/javascript">
    ...
    function SendRAQData() {
        ...
        var duedate = JSON.stringify(document.getElementById('DueDate_iso').value);;
        var projectBudget = JSON.stringify(' '); <%--JSON.stringify(document.getElementById('<%=txtProjectBudget.ClientID%>').value);--%>
        ...
        var emailOptIn = JSON.stringify($(".Email_Opt_In input:checkbox").is(':checked'));

        var responseData = '';
        $.ajax({
            type: "POST",
            url: "/Handlers/SaveREQData.ashx",
            data: '{"firstName": ' + firstName + ',"lastName":' + lastName + ',"emailAddress":"' + emailAddress + '","selectedCenter":"' + selectedCenter + '","phoneNumber":' + phoneNumber + ',"jobTitle": ' + jobTitle + ',"companyName":' + companyName + ',"projectName":' + projectName + ',"projectDescription":' + projectDescription + ',"uploadedFilesIds":"' + uploadedFilesIds + '","projectBudget":' + projectBudget + ',"DueDate":' + duedate + ',"EmailOptIn":' + emailOptIn + ' }',
    ...
    <div class="request_quote">
        ...
        <div class="rq_form_body clearfix">
            <div class="form" id="contact_project_info">
                ...
                <asp:TextBox ID="emailVerify" placeholder="Verify Your Email Address" CssClass="required" runat="server"   />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="emailVerify" ForeColor="Red" CssClass="required" runat="server" 
                     ValidationGroup="requestQuote"></asp:RequiredFieldValidator>
                <asp:compareValidator runat="server" ControlToValidate="email" ControlToCompare="emailVerify" Operator="Equal" Type="String" ForeColor="Red" CssClass="required" ValidationGroup="requestQuote"></asp:compareValidator>
                <span class="required">*</span>
    ...
    <div class="request_quote">
      ...
      <%--          <textarea cols="20" rows="4" placeholder="Describe Your Project" runat="server" class="descProject required"   id="descProject"></textarea>--%>
               ...
               <span class="required">*</span>-->              
                ...
                <asp:TextBox ID="txtProjectBudget" runat="server" placeholder="Project Budget" Visible="False" /> 
                <div class="clear"></div>
                <p class="terms_conditions">
                    ...
                    <label for="terms" class="small-text">I agree with the <a href="/Terms-and-Conditions/" target="_blank" class="red-text">Terms &amp; Conditions</a></label>
                    <span class="errorMessage termsLocal" style="display: none;">*You must select this box to proceed.</span>
                </p>
                <p class="Email_Opt_In">
                    <input type="checkbox" id="Email_Opt_In" runat="server" checked="checked" />
                    <label for="Email_Opt_In" class="small-text">Sign me up to receive emails and future promotions.</label>
                </p>
            </div>
        </div>
        <!-- end rq_form_body -->
