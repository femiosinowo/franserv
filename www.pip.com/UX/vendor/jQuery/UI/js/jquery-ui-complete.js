        ...
        close: function (event) {
            ...
            if (this.menuItems) {
                try {
                    ...
                    // Just hiding error from bug in selectmenu
                }
            }
...
//jquery.ui.selectmenu.popupStyle
(function (n) {
    n.widget("ui.selectmenu", n.ui.selectmenu, {
        options: {
            popup: !1
        },
        _drawButton: function () {
            this._super(), this.options.popup && this._setOption("icons", {
                button: "ui-icon-triangle-2-n-s"
            })
        },
        _drawMenu: function () {
            this._super(), this.options.popup && (this.menu.addClass("ui-corner-all").removeClass("ui-corner-bottom"), this.menuWrap.css("width", this.buttonText.width() + parseFloat(this.buttonText.css("padding-left")) || 0 + parseFloat(this.buttonText.css("margin-left")) || 0))
        },
        open: function (t) {
            if (!this.options.disabled)
                if (this.options.popup && this.items) {
                    var i;
                    this.isOpen = !0, this._toggleAttr(), i = this._getSelectedItem(), this.menu.outerHeight() < this.menu.prop("scrollHeight") && (this.menuWrap.css("left", -1e4), this.menu.scrollTop(this.menu.scrollTop() + i.position().top - this.menu.outerHeight() / 2 + i.outerHeight() / 2), this.menuWrap.css("left", "auto")), this.menuWrap.position(n.extend({}, this.options.position, {
                        of: this.button,
                        my: "left top" + (this.menu.offset().top - i.offset().top + (this.button.outerHeight() - i.outerHeight()) / 2),
                        at: "left top"
        ...
        _toggleAttr: function () {
            this._super(), this.options.popup && this.isOpen && this.button.toggleClass("ui-corner-top", !this.isOpen).toggleClass("ui-corner-all", this.isOpen)
        }
    })
})($ektron);