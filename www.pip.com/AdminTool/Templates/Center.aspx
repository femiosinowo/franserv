                        ...
                        <table width="100%" border="0" cellpadding="2" summary="">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtWhitePaperDownloadEmail"  runat="server" MaxLength="255" TextMode="MultiLine" 
                                            Width="400" Height="100" placeHolder="White Paper Download Email"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtJobApplicationEmail"  runat="server" MaxLength="255" TextMode="MultiLine" 
                                            Width="400" Height="100" placeHolder="Job Application Email"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtSubscriptionEmail"  runat="server" MaxLength="255" TextMode="MultiLine" 
                                            Width="400" Height="100" placeHolder="Subscription Email"></asp:TextBox>
                        ...
                        <table width="100%" border="0" cellpadding="2" summary="">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTwitterFeedUrl" runat="server" MaxLength="255" size="50" placeHolder="Twitter Feed URL: 'https://twitter.com/pipcorp'"></asp:TextBox>
