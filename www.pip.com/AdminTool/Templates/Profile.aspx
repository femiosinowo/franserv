                ...
                <tbody>
                   ...
                   <!-- <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlCenterId" runat="server" TabIndex="8">
                            </asp:DropDownList>
                    ...
                    <tr>
                        <td>
                            <span class="CS_Form_Label_Baseline"><strong>
                                <label id="lblEmailUsername" runat="server" for="fic_2269_2296">Email</label><asp:Label ID="lblUserName" Text="/Username" runat="server"></asp:Label>:</strong></span>
                        </td>
                        <td>
                            <asp:TextBox ID="txtEmail" runat="server" TextMode="Email" placeHolder="Email" ValidationGroup="AddProfile" size="30" MaxLength="255" TabIndex="7"></asp:TextBox>
                    ...
                    <tr style="visibility: visible;">
                        <td><span class="CS_Form_Label_Baseline">
                            <label for="imageUpload">Picture (453 * 453):</label></span></td>
                        <td>
                            <img alt="" src="#" id="userImage" visible="false" runat="server" />
                            <asp:FileUpload ID="imageUpload" TabIndex="14" runat="server" />
                            <br />
                            <label for="chkClearCurrentImg"><asp:CheckBox ID="chkClearCurrentImg" TabIndex="15" runat="server" Checked="false" /> Clear Current Image ?</label>
                            <br /><br />
                        </td>
                    </tr>                    
                    <tr id="isActiveSection" runat="server">
                        ...
                        <td>
                            <asp:CheckBox ID="chkIsActive" runat="server" TabIndex="16" Checked="true" />
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>
                            <asp:Button ID="btnAddProfile" CssClass="btnAddProfile" TabIndex="17" runat="server" Text="Save" ValidationGroup="AddProfile" OnClick="btnAddProfile_Click" />
                            <asp:Button ID="btnUpdateProfile" CssClass="btnAddProfile" TabIndex="17" runat="server" Text="Update" ValidationGroup="AddProfile" OnClick="btnUpdateProfile_Click" />
                        </td>
                    </tr>
                </tbody>
            </table>
