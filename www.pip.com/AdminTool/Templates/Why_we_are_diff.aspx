...
To get the correct Vimeo link, go to your video, click on Share, then embed and grab the url that begins with https://player.vimeo.com/ and ends with the video number.</p></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtVideoLink" Width="505px" PlaceHolder="Paste vimeo link here e.g. https://player.vimeo.com/video/105716916" runat="server" size="30" MaxLength="255" TabIndex="6"></asp:TextBox><br />
                           <%-- (sample Video URL: http://player.vimeo.com/video/61789173?title=0&byline=0&portrait=0) <br />--%>
                        </td>
                    </tr>
                    <tr>
                        <td class="CS_Form_Required_Baseline"><span class="CS_Form_Required_Baseline">
                            <label for="txtDescription">Image (570 * 325):</label></span></td>
                        <td>
