...
namespace SirSpeedy.CMS
{
    ...
    public class AdminToolManager
    {
        ...
        public static List<CountryData> GetAllCountryList()
        {
            ...
            try
            {
                string cacheKey = "SirSpeedyMain-AllCountryDataFromdb";
        ...
        public static AdminScreenPermissions GetUserPermission(string userRole, string username, bool refresh = false)
        {
            ...
            try
            {
                string cacheKey = "SirSpeedyMain-FransWorkareaData" + username;
                bool dataExistInCache = ApplicationCache.IsExist(cacheKey);
                    ...
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        ...
                        if (reader != null && reader.HasRows)
                        {
                            ...
                            while (reader.Read())
                            {
                                ...
                                if (reader.GetValue(14) != null && !String.IsNullOrWhiteSpace(reader.GetValue(14).ToString()))
                                {
                                    item.DueDate = DateTime.Parse(reader.GetValue(14).ToString());
                                }
                                ...
                                //    else
                                //        item.ServerDomain = "http://author.pip.com";
                                //}
                                //else
                                //{
                                    item.ServerDomain = "http://author.pip.com";
                    ...
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        ...
                        if (reader != null && reader.HasRows)
                        {
                            ...
                            while (reader.Read())
                            {
                                ...
                                //}
                                if (reader.GetValue(14) != null)
                                    item.ProjectDueDate = reader.GetValue(14).ToString();
                    ...
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        ...
                        if (reader != null && reader.HasRows)
                        {
                            ...
                            while (reader.Read())
                            {
                                ...
                                {
                                    externalLinks = "<a target=\"_blank\" href=\"" + item.FileLink + "\">" + item.FileLink + "</a>,";
                                }
                                else
                                {
                                    externalLinks += "<a target=\"_blank\" href=\"" + item.FileLink + "\">" + item.FileLink + "</a>,";
                            ...
                            while (reader.Read())
                            {
                                ...
                                if (reader.GetValue(14) != null)
                                {
                                    ...
                                    if (domain != "")
                                        ...
                                        data.ServerDomain = "http://author.pip.com";
                                }
                                else
                                {
                                    data.ServerDomain = "http://author.pip.com";
