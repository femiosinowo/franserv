    ...
    public class CloneContentAliasOnPublish : ContentStrategy
    {
        ...
        private bool IsValidContentType(long smartFormId)
        {
            ...
            if (smartFormId == newsSmartFormId)
                ...
                status = true;
            else if (smartFormId == productServicesSmartFormId)
                status = true;
            else if (smartFormId == productServicesSubCategorySmartFormId)
                status = true;
        ...
        {
            Log.WriteInfo("CloneContentAliasOnPublish::Request came in to ADD alias names for all the local centers with the national alias name " + aliasName + " and for the content id: " + contentId + "");
