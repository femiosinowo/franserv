                    ...
                    <div class="grid_8 sf_col two_col col2">
                        <div class="prefix_2 grid_20 suffix_2">
                            <div id="sf_location_map" class="static_map">
                                <img alt="map" id="googleMapImage" runat="server" src="http://maps.googleapis.com/maps/api/staticmap?size=336x206&amp;zoom=15&amp;markers=icon:http://author.pip.com/sandbox/sirspeedy/images/location-map-marker.png%7C33.976463,-118.036812&amp;style=feature:landscape%7Ccolor:0xe9e9e9&amp;style=feature:poi%7Celement:geometry%7Ccolor:0xd8d8d8&amp;sensor=true" />
                            ...
                            <div class="contact_location_info location_info">
                                ...
                                <hr />
                                <ul>
                                    <li class="contact-icon-hours"><span>
                                        <asp:Literal ID="ltrWorkingHours" runat="server"></asp:Literal>
                                    </span></li>
                                </ul>
                                <hr />
                            </div>
                            <div id="contact_social_icons" class="sf_social_icons">
