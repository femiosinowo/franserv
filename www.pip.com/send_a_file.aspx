    ...
    <div class="header_image_wrapper clearfix">
        <div class="header_image">
            <div class="header_image_content">
                <CMS:ContentBlock ID="cbheader" runat="server" DynamicParameter="id" CacheInterval="300" />
			    <%--<img src="images/headers/header_3.jpg" alt="Send a File"> --%>
		    </div><!-- header image-->
        </div><!-- end header_image -->
    </div><!-- end header_image_wrapper-->
    <div class="clear"></div>
    <!-- mmm NEW Login Content (National) mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm NEW Login Content (National) mmm -->
    <div id="loggedin-send-file" class="send_file">
    	    ...
    	    <div class="send_file_content clearfix">
                <div id="social_send_file_content" class="container_24">
                    <div class="send_file_main grid_18 col-height-equal">
                        ...
                        <div class="prefix_1 grid_22 suffix_1 alpha guest_register_saf">
                            <div class="contact_info">
						       ...
						       <ul>
                                   <li id="contact_name"><asp:Label runat="server" ID="lblUserName"></asp:Label></li>
							       <li id="contact_job_title"><asp:Label runat="server" ID="lblJobTitle"></asp:Label></li>
							       <li id="contact_company"><asp:Label runat="server" ID="lblCompanyName"></asp:Label></li>
							       <li id="contact_website"></li>
							       <li id="contact_email"><asp:Label runat="server" ID="lblUserEmail"></asp:Label></li>
							       <li id="contact_phone"><asp:Label runat="server" ID="lblPhoneNumber"></asp:Label></li>
                               </ul>
                           </div>
                           <hr />
                           <div class="clear"></div>
                           <div class="form " id="contact_project_info_pageform">
                                ...
                                <div class="sf_project_desc">
                                    ...
                                    <asp:TextBox ID="project_name" CssClass="required" runat="server" placeholder="Project Name*"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfv7" runat="server" ControlToValidate="project_name"
                                        CssClass="required" ValidationGroup="SendAFile" ErrorMessage="Project Name" ForeColor="Red">*</asp:RequiredFieldValidator>
                                    <div class="form_input_two_col project_desc_two_col">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfv8" runat="server" ControlToValidate="project_quantity"
                                            CssClass="required" ValidationGroup="SendAFile" ErrorMessage="Quantity" ForeColor="Red">*</asp:RequiredFieldValidator>
									    </div>
									    <div class="input_col input_col_two">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="project_due_date"
                                                 CssClass="required" ValidationGroup="SendAFile" ErrorMessage="Due Date" ForeColor="Red">*</asp:RequiredFieldValidator>       
									    </div>
								    </div>
                                ...
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" Style="margin: 0px;" ForeColor="Red" CssClass="required" runat="server" ControlToValidate="txtUploadFiles"
                                     ValidationGroup="SendAFile">*</asp:RequiredFieldValidator>--%>
                    ...
                    <p class="small_text gray" style="text-align: center; color:grey">
                                ...
                                <!-- end upload_files -->                                
                                <div class="clear"></div>
                                <%--<input class="white_btn" type="submit" id="login_submit_btn" value="Submit" />--%>
                                <asp:Button ID="submit_file" CssClass="white_btn btnSubmitSAF" runat="server" Text="Submit"
                           ...
                           </div> <!-- end contact_project_info_pageform -->
                        </div><!-- end prefix_1 grid_22 suffix_1 alpha -->
                    </div><!-- end grid 18 -->
                    <div class="send_file_sidebar grid_6 col-height-equal">
                        <span class="headline-block-icon-black"></span>
			            <h2 class="headline">Your Location</h2>
			            <div class="location_img static_map" id="sf_location_map">
                            <img alt="map" id="googleMapImage" runat="server" src="http://maps.googleapis.com/maps/api/staticmap?size=315x130&zoom=15&markers=icon:http://www.pip.com/images/location-map-marker.png|33.5650438,-117.6641133&style=feature:landscape|color:0xe9e9e9&style=feature:poi|element:geometry|color:0xd8d8d8&sensor=true" />
                        ...
                        <div class="your_location_info">
			              <ul>
                            <asp:Literal ID="ltrCenterAddress" runat="server"></asp:Literal>
				            <li id="location_phone"><asp:Literal ID="ltrPhone" runat="server"></asp:Literal></li>
				            <li id="location_phone2"><asp:Literal ID="ltrFax" runat="server"></asp:Literal></li>
				            <li id="location_email"><asp:Literal ID="ltrEmail" runat="server"></asp:Literal></li>
			              </ul>
			              <hr/>
			              <ul>
			                <li><strong>Hours</strong></li>
                            <asp:Literal ID="ltrWorkingHours" runat="server"></asp:Literal>
				            <%--<li>Mon-Sat 9am-9:30am</li>
				            <li>Sun 9am-8pm</li>--%>
			              </ul>
			              <hr/>
			            </div>
