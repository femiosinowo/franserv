...
<div class="site_container national send_file" id="guest-send-file">
    <!-- mmm Send File Content mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm Send File Content mmm -->
    <div class="send_file_content_wrapper  clearfix">
        <div class="send_file_content clearfix">
            <div id="guest02_send_file_content" class="container_24">
                <div class="send_file_main grid_18 col-height-equal">
                    ...
                    <div class="prefix_1 grid_22 suffix_1 alpha guest_register_saf">
                        <%--<div class="user_login_info">
						   ...
						   <ul>
						     <li id="user_login_username"><span>Username:</span> pamelasobotka</li>
							 <li id="user_login_password"><span>Password:</span> msnb52347</li>
						   </ul>
						</div>
                        <hr/>--%>
                         <h3>
                            ...
                            <ul class="contact_project_info_two_col">
						        <li>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfv3" runat="server" ControlToValidate="fname"
                                        CssClass="required" ValidationGroup="GuestRegister" ErrorMessage="First Name" ForeColor="Red">*</asp:RequiredFieldValidator>
                                </li>
						        <li>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfv5" runat="server" ControlToValidate="lname"
                                        CssClass="required" ValidationGroup="GuestRegister" ErrorMessage="Last Name" ForeColor="Red">*</asp:RequiredFieldValidator>
                                </li>
						    </ul>
						    <ul class="contact_project_info_two_col">
						        <li>
						    ...
						    <ul class="contact_project_info_two_col">
						        <li>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfv4" runat="server" ControlToValidate="email"
                                        CssClass="required" ValidationGroup="GuestRegister" ErrorMessage="Email Address" ForeColor="Red">*</asp:RequiredFieldValidator>
                                </li>
						        <li>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfv6" runat="server" ControlToValidate="phone"
                                        CssClass="required" ValidationGroup="GuestRegister" ErrorMessage="Phone Number" ForeColor="Red">*</asp:RequiredFieldValidator>
							...
							<div class="sf_project_desc">
							    ...
							    <div class="form_input_two_col project_desc_two_col">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfv8" runat="server" ControlToValidate="project_quantity"
                                            CssClass="required" ValidationGroup="GuestRegister" ErrorMessage="Quantity" ForeColor="Red">*</asp:RequiredFieldValidator>
									</div>
									<div class="input_col input_col_two">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="project_due_date"
                                            CssClass="required" ValidationGroup="GuestRegister" ErrorMessage="Due Date" ForeColor="Red">*</asp:RequiredFieldValidator>--%>
                    ...
                    <p class="small_text gray" style="text-align: center; color:grey">
						    ...
						    <div class="clear"></div>
                            <%--<input class="white_btn" type="submit" id="guest02_submit_btn" value="Submit" />--%>
                            <asp:Button ID="submit_file" CssClass="white_btn search btnSubmitSAF" runat="server"
                                 Text="Submit" ValidationGroup="GuestRegister" /> 
...
<!--mmmmmmmmmmmmmmmmmmmmmmmmmmmmm OLD send A File Local OLD mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm -->