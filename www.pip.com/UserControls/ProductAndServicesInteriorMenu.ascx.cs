...
public partial class UserControls_ProductAndServicesInteriorMenu : System.Web.UI.UserControl
{
            ...
            foreach (Ektron.Cms.ContentData contentData in contents)
            {
                try
                {
                    ...
                    if (lastIndex != 0)
                    {
                        ...
                        {
                            DTSource.Rows.Add(title, subtitle, imgSliderSRC, headerIconSmallWhite, hrefId, url, urlCssId, content, teaser, tagline, "", counter);
                        }
                    }
                    else
                    {
