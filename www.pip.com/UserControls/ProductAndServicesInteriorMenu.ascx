<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductAndServicesInteriorMenu.ascx.cs"
    Inherits="UserControls_ProductAndServicesInteriorMenu" %>
                    ...
                    <div class="top-menu-items">
                        <ul>
                            <asp:Repeater runat="server" ID="RptTopPSMenuItems">
                                ...
                                <ItemTemplate >
                                    <li><a href="<%# Eval("urlCssId") %>"><span><%# Eval("title") %></span></a></li>
                                </ItemTemplate>
                                </asp:Repeater>
                        </ul>
                    </div>
                    <div class="bottom-menu-items">
                        <ul>
                            <asp:Repeater runat="server" ID="RptBottomPSMenuItems">
                                <ItemTemplate>
                                    <li class="products-services-link"><a href="<%# Eval("urlCssId") %>"><span><%# Eval("title") %></span></a></li>
                                </ItemTemplate>
                            </asp:Repeater>
