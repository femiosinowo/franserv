        ...
        <div id="social_send_file_content" class="container_24">
                ...
                <div class="prefix_1 grid_22 suffix_1 alpha guest_register_saf">
                    ...
                    <div id="choose_center_pageform" class="form clearfix">
                        ...
                        <asp:RequiredFieldValidator ID="rfv1" runat="server" ControlToValidate="txtRegisterLocation"
                            CssClass="required" ErrorMessage="Enter City, State, Zip required" ValidationGroup="SocialRegisterMap">*</asp:RequiredFieldValidator>
                        ...
                        <asp:RequiredFieldValidator ID="rfv2" runat="server" ControlToValidate="txtRegisterChooseLocation"
                            CssClass="required" ValidationGroup="SocialRegisterMap" ErrorMessage="Pick a location" ForeColor="Red">*</asp:RequiredFieldValidator>
                        <div class="clear">
                        </div>
            ...
            <div class="send_file_sidebar grid_6 col-height-equal">
                <div class="prefix_2 grid_20 suffix_2">
                    ...
                    <a class="cta-button-text" href="/Why-We-Are-Different/">
