...
public partial class UserControls_ProductsAndServicesIndexFooterUpper : System.Web.UI.UserControl
{
    ...
    {
        fransId = FransDataManager.IsFranchiseSelected() ? FransDataManager.GetFranchiseId() : "0";
        if (!IsPostBack)
        {
    ...
    {
        string cacheKey = String.Format("Pip:UserControls_ProductsAndServicesIndexFooterUpper:GetBriefsWHitepaperContent:FranchiseId={0}",
            fransId);
    ...
    {
        string cacheKey = String.Format("Pip:UserControls_ProductsAndServicesIndexFooterUpper:GetBriefsWHitepaperLocalContent:FranchiseId={0}",
            fransId);
