    ...
    <div class="footer_links">
        <div class="container_24">
            <div class="grid_24">
                ...
                <div id="siteLangSelector" visible="false" runat="server">
                    <ul>
                         <li id="country">
